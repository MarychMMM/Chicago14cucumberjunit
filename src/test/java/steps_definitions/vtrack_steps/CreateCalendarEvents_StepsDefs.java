package steps_definitions.vtrack_steps;
...
public class CreateCalendarEvents_StepsDefs {


    private LoginPage lp = new LoginPage();

    private CreateCalendarEventPage createPage = new CreateCalendarEventPage();
...
createPage.repeatCheckBox.click();
    ...
    public void the_user_sees_the_Repeats_select_field_with_the_following_options_Daily_Weekly_Monthly_Yearly() {
        ...
        List <String> expectedOptions = new ArrayList<>(List.of("Daily", "Weekly","Monthly", "Yearly"));
    ...
    @When("the user is on the All Calendar Events page under the Activities tab")
    public void theUserIsOnTheAllCalendarEventsPageUnderTheActivitiesTab() {
            DashboardsPage.navigateToModule("Activities","Calendar Events");
        }
    }
